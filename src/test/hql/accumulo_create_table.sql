...
add jar /opt/cloud/accumulo-trunk/trunk/lib/guava-13.0.1.jar;
add jar /opt/cloud/zookeeper-3.4.2/zookeeper-3.4.2.jar;
...
CREATE EXTERNAL TABLE test_table(value STRING, blah STRING) 
